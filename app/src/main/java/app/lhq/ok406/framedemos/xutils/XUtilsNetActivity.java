...
//                Toast.makeText(XUtils3NetActivity.this, "文件上传", Toast.LENGTH_SHORT).show();
    ...
    private void uploadFile() {
        RequestParams params = new RequestParams("http://192.168.1.104:8080/FileUpload/FileUploadServlet");
        //以表单方式上传
        params.setMultipart(true);
        //设置上传文件的路径
        params.addBodyParameter("File",new File(Environment.getExternalStorageDirectory()+"/lhq/480.mp4"),null,"oppo.mp4");
    ...
    private void downloadFile() {
        ...
        //设置保存数据
        params.setSaveFilePath(Environment.getExternalStorageDirectory() + "/lsq/480.mp4");
        //设置是否可以立即取消下载
        ...
        x.http().get(params, new Callback.ProgressCallback<File>() {
            ...
            @Override
            public void onFinished() {
                Log.e("TAG","onFinished!下载完成!!!");
                Log.e("Use-Time", String.valueOf(System.currentTimeMillis()-curTime));
            }
