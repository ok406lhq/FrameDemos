package app.lhq.ok406.framedemos.recyclerview;
...
//        recyclerview.addItemDecoration(new DividerListItemDecoration(RecyclerViewActivity.this,DividerListItemDecoration.VERTICAL_LIST,R.drawable.drawable_recyclerview));
    ...
    private void initView() {
        setContentView(R.layout.activity_rrecyclerview);
