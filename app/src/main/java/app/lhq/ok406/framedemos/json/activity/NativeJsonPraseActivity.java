...
import app.lhq.ok406.framedemos.json.bean.DataInfo;
import app.lhq.ok406.framedemos.json.bean.FilmInfo;
import app.lhq.ok406.framedemos.json.bean.ShopInfo;
// 手动JSON解析页面
