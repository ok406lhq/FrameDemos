package app.lhq.ok406.framedemos.afinal;
...
/**
 * 项目名：FrameDemos
 * 包名：app.lhq.ok406.framedemos.afinal
 * 文件名：AfinalActivity
 * 创建者：lhq
 * 创建时间：2017/12/30 0030 10:04
 * 描述： TODO
 */
...
public class AfinalActivity extends FinalActivity {
    ...
    public void bt_afinal_loadimage_click(View view){
        ...
        // 网络请求图片时默认显示的图片
        finalBitmap.configLoadingImage(R.drawable.doge);
    ...
    public void bt_afinal_updatetext_click(View view){
        ...
        // 文件上传到服务器的位置
        String url  = "http://192.168.1.102:8080/FileUpload/FileUploadServlet";
